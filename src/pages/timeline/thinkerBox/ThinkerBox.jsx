...
import thinker1 from "../../../assets/images/animationThinkerTimeline/00.png";
import thinker2 from "../../../assets/images/animationThinkerTimeline/01.png";
...
import thinker9 from "../../../assets/images/animationThinkerTimeline/09.png";
const ThinkerBox = () => {
  return (
    <>
      ...
      <div className="thinkerBox">
        ...
        <LazyLoadImage src={thinker9} loading="lazy" />
      </div>
    </>
  );
};
